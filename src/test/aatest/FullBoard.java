...
public class FullBoard extends JPanel {
    private MainFrame mainFrame; // MainFrame 참조 저장
    ...
    // MainFrame을 받는 생성자 추가
    public FullBoard(MainFrame mainFrame) {
        this.mainFrame = mainFrame;
    }

    void init(String[] img, MainFrame mainFrame, String userId, long startTime) {
