...
public class Level7Scene extends JFrame implements ActionListener {
	...
	String[][] low = new String[5][10]; 
	String[][] col = new String[5][10];
	...
	public Level7Scene() {
		...
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < 10; j++) {
				...
				colNumber[i][j].setLocation(210 + i * 40, 200 + j * 40);
